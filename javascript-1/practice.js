...
var myName = "Bryan 'the bryman' charles hawkins"
...
// Create a function called 'iLove' that takes in two parameters, name which will be a string  and love which will be a string of 
// something you love. Have the function take the two parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" 
// with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"
...
// 'reversed'. Using a for loop, loop over the passed in array in reverse and add each item to the new reversed array. Finally, return 
...
// IF YOU REFERENCE THIS THIS IS HOW YOU HAD IT WRONG FOR AN HOUR
...
myNumbersIndex = [];
myNumbersIndex.push.forEach(myNumbers) //not even close on this one
...
let totallyAwesome = people.reduce(function(total, element, index, array){
	return awesomeLevel.total + element.total
